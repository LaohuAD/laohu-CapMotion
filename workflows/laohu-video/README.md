...
这里集中保存 Laohu Voice2Motion FrameCut 的内容剪辑、字幕和动画工作流。Cap 产品源码位于仓库根目录；本目录只保存 Agent 如何理解和加工口播视频所需的规则、脚本、模板和可追溯记录。

## 单一入口

```text
规范/          项目级制作规则和判断标准
模板/          EDL、字幕、Remotion、HyperFrames 和组件资产
示例/          可以公开、没有隐私信息的配置示例
...
2. 画面和动画：读取 `规范/画面表达规则.md`、`规范/组件设计方法论.md`、`规范/双引擎协作规则.md`。
