...
const en = {
	...
	"shortcuts.editor.title": "Editor shortcuts",
	"shortcuts.editor.description":
		"Set local timeline shortcuts. These only work inside the editor and can be cleared or reassigned.",
	"shortcuts.editor.trimPrevious": "Trim and remove before the playhead",
	"shortcuts.editor.splitAtCursor": "Split at the playhead",
	"shortcuts.editor.trimNext": "Trim and remove after the playhead",
	"shortcuts.editor.reset": "Restore defaults",
	"shortcuts.editor.conflict": "This shortcut is already used by {action}",
...
const zhCN: Record<keyof typeof en, string> = {
	...
	"shortcuts.editor.title": "编辑器快捷键",
	"shortcuts.editor.description":
		"设置只在编辑器内生效的时间线快捷键，可重新绑定、清除或恢复默认值",
	"shortcuts.editor.trimPrevious": "分割并删除播放头之前的内容",
	"shortcuts.editor.splitAtCursor": "在播放头处分割",
	"shortcuts.editor.trimNext": "分割并删除播放头之后的内容",
	"shortcuts.editor.reset": "恢复默认值",
	"shortcuts.editor.conflict": "这个快捷键已用于「{action}」",
