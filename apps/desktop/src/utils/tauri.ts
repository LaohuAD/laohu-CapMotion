...
async toggleManualZoom() : Promise<null> {
    return await TAURI_INVOKE("toggle_manual_zoom");
},
...
manualZoomChanged: ManualZoomChanged,
...
manualZoomChanged: "manual-zoom-changed",
...
export type CurrentRecording = { target: CurrentRecordingTarget; mode: RecordingMode; status: RecordingStatus; sessionId: string | null; elapsedMs: number; paused: boolean }
...
export type GeneralSettingsStore = { instanceId?: string; uploadIndividualFiles?: boolean; hideDockIcon?: boolean; autoCreateShareableLink?: boolean; enableNotifications?: boolean; disableAutoOpenLinks?: boolean; hasCompletedStartup?: boolean; theme?: AppTheme;
/**
...
export type HotkeyAction = "startStudioRecording" | "startInstantRecording" | "stopRecording" | "restartRecording" | "togglePauseRecording" | "toggleManualZoom" | "cycleRecordingMode" | "openRecordingPicker" | "openRecordingPickerDisplay" | "openRecordingPickerWindow" | "openRecordingPickerArea" | "screenshotDisplay" | "screenshotWindow" | "screenshotArea" | "other"
...
export type ManualFollowConfig = { comfortZoneRatio: number; outerGuardRatio: number; slowResponse: number; fastResponse: number; predictionHorizonSecs: number; maxLeadRatio: number }
...
export type MotionArtifact = { id: string; segmentId: string; contentHash: string; quality: MotionArtifactQuality; status: MotionArtifactStatus; path: string; width: number; height: number; fps: number; hasAlpha: boolean; duration: number; error: string | null }
export type MotionArtifactQuality = "preview" | "final"
export type MotionArtifactStatus = "ready" | "rendering" | "stale" | "failed"
export type MotionConfiguration = { definitions: MotionDefinition[]; segments: MotionSegment[]; artifacts: MotionArtifact[] }
