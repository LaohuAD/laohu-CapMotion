...
const modeOptions = [
	{
		...
		title: "capture.mode.instantTitle" as TranslationKey,
		description: "capture.mode.instantDescription" as TranslationKey,
		icon: IconCapInstant,
	},
	{
		mode: "studio" as RecordingMode,
		title: "capture.mode.studioTitle" as TranslationKey,
		description: "capture.mode.studioDescription" as TranslationKey,
		icon: IconCapFilmCut,
	},
	{
		mode: "screenshot" as RecordingMode,
		title: "capture.mode.screenshotTitle" as TranslationKey,
		description: "capture.mode.screenshotDescription" as TranslationKey,
